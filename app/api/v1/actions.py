...
from .types import ActionListResponse
import inspect
import importlib
...
async def list_actions(limit: int = None, offset: int = None, page: int = None, cursor: str = None, sort_by: str = None, order: str = "asc"):
	...
	items = list(actions_by_id.values())
	...
	return {"actions": pag["items"], "total": pag["total"], "limit": pag["limit"], "offset": pag["offset"], "next_cursor": pag.get("next_cursor"), "prev_cursor": pag.get("prev_cursor")}
